...
const FormComponent = () => {
    ...
    const { startDate, visit_category, get_visit, apply_tos, getSelectedVisit } = watch()
    ...
    const getCategory = useCallback(async () => {
        await visit.apiGetVisitCategorys({ visit_category: visit_category }).then((res) => {
    ...
    const getVisit = useCallback(async () => {
        ...
        if (visit_category != undefined) {
            await visit.apiGetVisits({ visit_category: visit_category }).then((res) => {
                res.data.map((v) => {
                    visits.push({
                        value: v.value,
                        label: v.label
    ...
    return (
        <div className="space-y-4 mt-4">
            {!isSubTask &&
                <Console.FormGroup className='w-full' mode='horizontal' label="Visit Type" required errors={errors.get_visit}>
            ...
            <Console.FormGroup className='w-full' mode='horizontal' name="taskName" label="Task Name" required errors={errors.taskName}>
                <Console.FormInput
                    ...
                    placeholder="eg: Visit South Area"
                    autoComplete="off"
                />
            </Console.FormGroup>
            <Console.FormGroup className='w-full items-start' mode='horizontal' name="description" label="Description" required errors={errors.description}>
                <Console.FormTextarea
                    ...
                    placeholder="eg: Find QR Code in south area and scan. Collect rewards for 10 points"
                    autoComplete="off"
                />
            </Console.FormGroup>
        ...
        <div className="p-4 mb-4 border border-slate-200/60 rounded">
            <div className='flex w-full gap-4 items-center'>
                <div className='w-full flex gap-4'>
                    ...
                    <Console.FormGroup className='w-6/12' mode='vertical' label="Visit Type" required errors={errors.subtaskform?.[index]?.get_visit}>
