...
const ListPage = () => {
  ...
  const exportReport = async () => {
    ...
    if (area_name != undefined && filterData.start_date != undefined && filterData.end_date != undefined) {
      ...
      link.href = `${report.exportExit()}&${parameter}`
      link.click();
    }
  }
  ...
  return (
    <>
      <NextSeo title="Check Point | Report Exit Gate | List" noindex />
      <h2 className="mt-6 text-2xl font-medium">Report Exit Gate</h2>
