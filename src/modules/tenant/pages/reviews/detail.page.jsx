...
const DetailPage = () => {
  ...
  return (
    <>
      <NextSeo title="F&B | Review | Detail" noindex />
      <div className="flex items-center my-8 gap-4">
        <Console.Button variant='dark' onClick={() => router.push('/tenant/reviews')}>
          <Console.Lucide icon='ArrowLeft' className='h-5 w-5' />
        </Console.Button>
        <h2 className="mr-auto text-2xl font-medium">Review Detail</h2>
      </div>
