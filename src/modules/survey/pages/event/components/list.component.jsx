...
const ListComponent = ({
  ...
  const items = [
    ...
    },
    {
      label: 'Participants',
      render: (row) => (
        <a href={`/survey/event-survey/participants/${row.id}`}>
          {row.participants}
        </a>
      )
    },
    ...
    },
    {
      ...
      render: (row) => (
        <div className='flex gap-4'>
          <a href={`/survey/event-survey/${row.id}`}>
    ...
    <div className="intro-y transition-all duration-500 group">
      ...
      <Console.Dialog
        ...
        <Console.Dialog.Panel>
          ...
          <h1 className='px-5 font-semibold text-2xl text-center'>Event Survey Link</h1>
