      ...
      <div className="col-span-12">
        <div className="p-5 box mt-5">
          <div className="">
            ...
            <div className="mt-4">
              <Console.FormLabel htmlFor="group_title" className="text-sm">Group Title<span className="text-danger">*</span></Console.FormLabel>
              <Console.FormInput
                ...
                className={clsx([
                  "block min-w-full",
                  { "border-danger": errors.group_title }
                ])}
              ...
              {errors.group_title && (
                <div className="mt-2 text-danger text-sm">
                  {typeof errors.group_title.message === "string" &&
